...
const Home = () => {
  ...
  return (
    <Layout sidebar style={{ gridTemplateRows: "1fr auto" }}>
      ...
      <Grid customCols='1fr auto auto' placeItems='stretch' width='100%' padding='.75em 0'>
        <span />
      <Text
          className="pointer"
        ...
        <Text bold textAlign='left' size='1.25em'> Parking Admin
        ...
        <Card>
          ...
          <div style={{textAlign: 'left', padding: '0 0 1em 1em'}}>
            ...
            <NavLink to={"/e-permits/vehicle"} target='_'><div>Client Vehicle E-Permit Form</div></NavLink>
          </div>
        </Card>
        <br/>
